...
/////////////////////////////////////////////////////////////////////
contract ShareAuthVote_1 {
///////////////////////////COMMITTEE KEYS//////////////////////////
address Apollo = 0x06400992be45bc64a52b5c55d3df84596d6cb4a1;

/*contract whitelist data structure*/
struct ShareAutVote_1 {
bool authorised;
address addr;  
}
/*contract whitelist */
mapping (uint8 => ShareAutVote_1) public ShareAutVotePass;
...
uint8 AuthorityProposal; //change authority given to Atlas key
}	
...
function InitShareAuth(uint8 accountid_sav1,address addr_sav1){  
...
ShareAutVotePass[accountid_sav1].authorised = true;
ShareAutVotePass[accountid_sav1].addr = addr_sav1;
}//////////////////////////////////////////////////////////
...
SokMintOne
SokMintOneCall = SokMintOne(ShareAutVotePass[5].addr);
...
SokTreasuryOne
SokTreasuryOneCall = SokTreasuryOne(ShareAutVotePass[8].addr);
...
/*function for changing zeus key authority*/
function NewAuthProposal(uint8 change_auth)	
returns (bool sucess){	
...
SokVoteRegister
SokVoteRegisterCall = SokVoteRegister(ShareAutVotePass[10].addr);
...
/*set up call to share one*/
SokShareOne
SokShareOneCall = SokShareOne(ShareAutVotePass[11].addr);
(SokShareOneCall.AuthChange(ChangeA.Auth));
}  
if (YesResult() == true){
...
}///////////////////////////////end of share_auth_vote_1 contract
